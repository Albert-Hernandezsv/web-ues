<x-app-layout>
    ...
    <div class="py-10">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{ route('admin.pages.descargas.update') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                @csrf
                @method('PUT')
                ...
                <div class="flex items-center gap-4">
                    ...
                    <a href="{{ route('admin.downloads.index') }}" class="rounded-xl bg-slate-900 px-6 py-3 font-semibold text-white hover:bg-black transition">
